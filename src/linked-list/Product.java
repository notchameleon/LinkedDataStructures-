 ...
 * 
 * We must cast Product because we're only given an object and we Need product to access things such as getPrice() or quantity. 
 * 
 */
public class Product implements Comparable<Object>
{
	...
	{
		Product otherProduct = (Product) otherItem;
		return prodId.compareTo(otherProduct.prodId);
	}
